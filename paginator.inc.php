...
**									-Se incluy� la opci�n de personalizar los enlaces a la p�gina primera y a la �ltima.
**	Versi�n 1.7.0	(27/03/2020):	-Luego de 14 años, se ha adaptado a Mysqli, funcional con PHP 7.X
**
**-----------------------------------------------------------------------------------------------------------*/
 ...
 * ------------------------------------------------------------------------
 * $_pagi_con 					OBLIGATORIA.	Cadena. Debe contener una conexión válida a una Base de Datos.
...
// Función de reemplazo para mysql_result
 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
  $pagi_preConta = stristr($_pagi_sql,"FROM");
 	$_pagi_sqlConta = "SELECT COUNT(*) $pagi_preConta";
 	$_pagi_result2 = mysqli_query($pagi_con, $_pagi_sqlConta);
	...
	$_pagi_result3 = mysqli_query($pagi_con, $_pagi_sql);
	// Si ocurri� error y mostrar errores est� activado
 ...
 */
 ...
 $_pagi_result = mysqli_query($pagi_con, $_pagi_sqlLim);
 // Si ocurri� error y mostrar errores est� activado
